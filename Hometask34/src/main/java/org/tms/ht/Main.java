...
//        List<UserEntity> list = UserSearchDto.searchByRole(UserRole.USER);

//        List<UserEntity> list = UserSearchDto.searchByDate(new Date(100, 10, 4), new Date(100, 10, 12));

        List<UserEntity> list = UserSearchDto.searchByTaskStatus(TaskStatus.IN_PROGRESS);
